                        ...
                        case "invasion-main": {
                            ...
                            for(int i=0;i<7;i++){
                                ...
                                if(i<cnt){
                                    ...
                                    gui.addItem("prog-"+i, Message.getMessage("combat.progress.invasion.defend.name").add("defender", nation.getColorTag()+nation.getName()).toString(), pos, ColorUtils.getClosest(nation.getColor()).banner(), 1)
