...
import cn.jason31416.betternations.nation.resolution.VetoTreatyResolution;
...
public class TreatyVetoCommand extends ChildCommand {

    public TreatyVetoCommand(IParentCommand parent) {
        super("veto", parent);
    }
    ...
    public Message execute(ICommandContext context) {
        ...
        new VetoTreatyResolution(context.getPlayer().getNation(), context.getPlayer(), treaty).propose();
        return null;
    }
