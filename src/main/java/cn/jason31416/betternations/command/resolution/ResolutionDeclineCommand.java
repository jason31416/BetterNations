...
public class ResolutionDeclineCommand extends ChildCommand {
    public ResolutionDeclineCommand(IParentCommand parent) {
        super("decline", parent);
    }
    ...
    public Message execute(ICommandContext context) {
        ...
        if(!resolution.canUnsign(player)){
            return Message.getMessage("command.failed.resolution-not-signed");
        }
        resolution.unsign(player);
        return null;
    }
